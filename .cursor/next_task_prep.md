...
- **handoff_archive**: `.cursor/handoff/archive/TASK-0012B-kernel-smp-v1b-scheduler-smp-hardening.md` (latest completed-task snapshot)
- **linked_contracts**:
...
- **first_action**: Start TASK-0013 QoS/timed-coalescing slice on top of TASK-0012+0012B contracts (no marker-semantics drift).

## Start slice (now)
- **slice_name**: TASK-0013 Phase 0 — QoS/timer contract wiring on hardened scheduler baseline
...
- **touched_paths_allowlist_present**: YES
  - TASK-0013 task defines its own allowlist (must be followed strictly)
