...
11. `execd: elf load ok` – userland loader mapped the ELF and spawned the child
12. `child: hello-elf` – ELF payload printed its marker and yielded
13. `SELFTEST: e2e exec-elf ok` – selftest client confirmed the ELF loader path
