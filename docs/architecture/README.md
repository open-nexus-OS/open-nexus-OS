...
- OS/QEMU live-input contract: `docs/rfcs/RFC-0053-input-v1_0b-os-qemu-live-input-hidrawd-touchd-inputd-contract.md` (`In Progress`; host crates, IDL seeds, touch routing, and the narrow in-process QEMU proof are landed, but separate daemon startup/wiring and broad closure gates remain open)
