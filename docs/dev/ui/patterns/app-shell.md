...
The app shell defines common surfaces used by apps:

- top-level navigation,
- command surfaces (search/command palette),
- modal and sheet conventions,
- consistent spacing, typography, and focus behavior.

The sections below describe the **recommended** app shell, layering, and windowing patterns for Open Nexus OS.

They are guidance, not a hard ABI: apps may deviate, but should keep the same design language and remain cross-device.

See also:

- Profiles: `docs/dev/ui/foundations/layout/profiles.md`
- Windowing: `docs/dev/ui/patterns/wm.md`, `docs/dev/ui/patterns/wm-snap.md`
