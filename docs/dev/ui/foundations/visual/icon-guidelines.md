...
- Default set: **Lucide** (see `docs/dev/ui/foundations/visual/icons.md` for sizes/strokes).
...
Use the canonical sizes/strokes from `docs/dev/ui/foundations/visual/icons.md`:
...
- Prefer integer pixel sizes and snap placement to whole pixels (see `docs/dev/ui/foundations/layout/display-scaling.md`).
