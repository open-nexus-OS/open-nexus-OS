...
- RFC-0053: Input v1.0b OS/QEMU live-input path (`hidrawd` + `touchd` + `inputd`) contract seed (In Progress; execution SSOT is `TASK-0253`, with live-ingestion authority and marker-honesty contract)
...
- RFC-0053: Input v1.0b OS/QEMU live-input path (`hidrawd` + `touchd` + `inputd`) contract seed (In Progress; execution SSOT `TASK-0253`)
