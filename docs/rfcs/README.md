...
- RFC-0051: UI v2a visible input (cursor + hover + focus + click) contract seed (In Progress; deterministic TASK-0056B proofs green, live QEMU input moved to `TASK-0252`/`TASK-0253`)
