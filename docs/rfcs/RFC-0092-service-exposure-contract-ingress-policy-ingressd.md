...
- **Phase 1 (Layer A — bind gate: `any` only for the gateway; `SELFTEST: ingress deny ok`)**: ⬜ (TASK-0052 P1)
...
- [ ] **Phase 1**: Layer A bind gate — proof: `test_reject_nonloopback_bind_without_intent`, `SELFTEST: ingress deny ok`
