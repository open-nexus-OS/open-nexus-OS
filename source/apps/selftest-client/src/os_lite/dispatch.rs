...
//! CONTEXT: `os_lite` phase dispatch — QoS lane selection, profile gating,
//! verdict aggregation, and the twelve-phase run order (extracted from
//! `mod.rs` to keep the aggregator within the ADR-0027 LoC ceiling).
//! OWNERS: @runtime
//! STATUS: Functional
...
use super::{context, phases, profile};
