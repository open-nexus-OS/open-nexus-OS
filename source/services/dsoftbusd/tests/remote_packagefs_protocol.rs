...
use packagefs_ro::{
    decode_packagefs_resolve_rsp, encode_open_rsp, encode_read_rsp, encode_stat_rsp,
    encode_status_only, parse_request, reject_reason_to_status, PackagefsRequest, RejectReason,
    PK_MAGIC0, PK_MAGIC1, PK_MAX_HANDLES, PK_MAX_READ_LEN, PK_OP_CLOSE, PK_OP_OPEN, PK_OP_READ,
    PK_OP_STAT, PK_STATUS_BADF, PK_STATUS_BAD_REQUEST, PK_STATUS_IO, PK_STATUS_LIMIT,
    PK_STATUS_NOT_FOUND, PK_STATUS_OK, PK_STATUS_OVERSIZED, PK_VERSION, PACKAGEFSD_OP_RESOLVE,
    PACKAGEFS_KIND_FILE, PK_MAX_OPEN_FILE_BYTES,
};
...
fn test_status_mappings_cover_all_task_required_statuses() {
    ...
    assert_eq!(s_not_found[..5], [PK_MAGIC0, PK_MAGIC1, PK_VERSION, PK_OP_STAT | 0x80, PK_STATUS_NOT_FOUND]);
    ...
    assert_eq!(s_limit[..5], [PK_MAGIC0, PK_MAGIC1, PK_VERSION, PK_OP_OPEN | 0x80, PK_STATUS_LIMIT]);
