...
pub use visible_contract::{
    ...
    visible_pointer_transform, visible_route_space, visible_sidebar_close_target_contains,
    visible_sidebar_open_target_contains, LIVE_POINTER_DENOMINATOR, LIVE_POINTER_MAX_OUTPUT,
    LIVE_POINTER_NUMERATOR, LIVE_POINTER_THRESHOLD, VISIBLE_INPUT_CURSOR_END_X,
    VISIBLE_INPUT_CURSOR_END_Y, VISIBLE_INPUT_CURSOR_START_X, VISIBLE_INPUT_CURSOR_START_Y,
