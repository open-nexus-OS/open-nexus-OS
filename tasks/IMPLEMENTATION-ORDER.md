...
| TASK-0056 | UI v2a: double-buffered surfaces + present scheduler + input routing (In Progress; v2a host/reject/QEMU proofs green; final user-blocked gates pending) |
