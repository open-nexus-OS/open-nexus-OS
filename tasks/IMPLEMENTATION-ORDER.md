...
| 24 | TASK-0324 | Display-Handoff deterministisch per Konstruktion (Lane nach dem 2026-09-09-Schwarzbild): P0 Build-Wahrheit (Feature-SSOT im Manifest, gekeyte Artefakte, Provenance-Gate, `gpud: features=…`, Scanout-Policy ohne 2D-Retry auf GL) + `visible`-Pixel-Lane; P1 RFC-0093/ADR-0062; P2 `@ready`; P3 Routing v2; P4 EINE Slot-SSOT (alle Bespoke-Arme gelöscht); P5 Stage-Fence; P6 Handoff v2; P7 Polls weg; P8/P9 Abschluss | In Progress 2026-09-09 (P0) |
