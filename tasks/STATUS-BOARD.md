...
Current queue head: `TASK-0023B` (`Draft`, in-flight; Phases 1–4 closed 2026-04-17; Phases 5–6 remaining = signed evidence bundles + replay capability).
...
Next sequencing policy: `TASK-0023B` Phase 5 (signed evidence bundles, 6 cuts) → Phase 6 (replay capability, 6 cuts) → `TASK-0024` (reliability/recovery/congestion features) → `TASK-0044` (advanced tuning breadth).
