...
mod tests {
    ...
    use windowd::{
        ...
        SELFTEST_UI_VISIBLE_INPUT_OK_MARKER, SELFTEST_UI_VISIBLE_WHEEL_OK_MARKER,
        VISIBLE_CURSOR_BGRA, VISIBLE_FOCUS_BGRA, VISIBLE_INPUT_CLICK_BGRA, WHEEL_VISIBLE_MARKER,
    };
    ...
    fn visible_input_smoke_couples_cursor_focus_and_click_to_frame_pixels() {
        ...
        assert_eq!(WHEEL_VISIBLE_MARKER, "windowd: wheel visible");
        assert_eq!(SELFTEST_UI_VISIBLE_WHEEL_OK_MARKER, "SELFTEST: ui visible wheel ok");
    }
