...
use animation::{AnimationDriver, SpringSim, SpringConfig, AnimProp, LayerId, Easing};
...
fn spring_removed_after_convergence() {
    ...
    let mut d = AnimationDriver::new();
    d.spring_to(LayerId(1), AnimProp::Opacity, 0.0, 1.0, SpringConfig { stiffness: 500.0, damping: 50.0, mass: 1.0, initial_velocity: 0.0 });
