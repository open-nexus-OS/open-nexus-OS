...
pub trait GfxBackend {
    ...
    fn create_resource(&mut self, w: u32, h: u32, fmt: PixelFormat) -> Result<ResourceId, crate::error::GfxError>;
    fn transfer_to_host(&mut self, res: ResourceId, rect: Rect) -> Result<(), crate::error::GfxError>;
